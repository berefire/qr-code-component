...
![GitHub last commit](https://img.shields.io/github/last-commit/berefire/qr-code-component)
![Repo size](https://img.shields.io/github/repo-size/berefire/qr-code-component)
...
| _Mobile Preview (375x914)_                     | _Desktop Preview (1024x914)_                 |
| ---------------------------------------------- | -------------------------------------------- |
| ![Mobile](./assets/screenshots/mobile.png)     | ![Desktop](./assets/screenshots/desktop.png) |
